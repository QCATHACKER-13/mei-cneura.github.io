...
int main() {
    try {
        ...
        //net.set_task(REGRESSION); // Set task type to classification
        //net.learning(hyper_config.step_size, hyper_config.threshold_error);
        //net.enforce_learning(hyper_config.step_size, hyper_config.threshold_error);
        net.set_task(CLASSIFICATION); // Set task type to classification
        net.learning(hyper_config.step_size, hyper_config.threshold_error);
        //net.enforce_learning(hyper_config.step_size, hyper_config.threshold_error);
