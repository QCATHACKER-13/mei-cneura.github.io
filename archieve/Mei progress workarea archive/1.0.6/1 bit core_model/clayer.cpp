...
int main() {
    ...
    Layer h1layer(
        ...
        HIDDEN, UNIFORM, LEAKY_RELU, EXPDECAY, ADAM, MSE
    );
    ...
    Layer olayer(
        ...
        learning_rate, decay_rate, beta,
        OUTPUT, UNIFORM, LEAKY_RELU, EXPDECAY, ADAM, MSE
    );
    ...
    olayer.gradient_olayer();
    h2layer.gradient_hlayer(olayer.get_gradient(),olayer.get_weight());
    h1layer.gradient_hlayer(h2layer.get_gradient(),h2layer.get_weight());
