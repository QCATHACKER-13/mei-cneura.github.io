...
private:
    ...
    // Activation function (use tanh or sigmoid)
...
public:
          ...
          noise_dist(0.0, perturb_std)
    {
        ...
        for (auto& w : weights) {
            w = ((double)rand() / RAND_MAX - 0.5) * 2.0;  // Random init in [-1, 1]
        }
        bias = 0.0;
    }
    ...
    void local_update(double target) {
        ...
        // Generate perturbed weights and bias
        ...
        // Compute perturbed output and energy
